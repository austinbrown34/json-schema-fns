...
export type SchemaDocument = StringSchema | NumberSchema | IntSchema | ObjectSchema | ArraySchema | BooleanSchema | NullSchema;
export type AnySchema = BaseSchema;
export type StringFormat = "date-time" | "time" | "date" | "duration" | "email" | "idn-email" | "hostname" | "idn-hostname" | "ipv4" | "ipv6" | "uuid" | "uri" | "uri-reference" | "iri" | "iri-reference" | "uri-template" | "json-pointer" | "relative-json-pointer" | "regex";
type MimeType = "application/json" | "application/xml" | "text/xml" | "text/html" | "text/plain" | "application/octet-stream" | "text/css" | "text/csv" | "text/javascript" | "image/jpeg" | "image/png" | "image/gif" | "image/webp" | "image/bmp" | "image/apng" | "image/svg+xml" | "image/avif" | "video/webm" | "video/mp4" | "video/ogg" | "multipart/form-data";
...
export type ObjectSchema = BaseSchema & PropertiesSchema & {
